        ...
        _this.change(function () {
            if (this.value) {
                ...
                if (navigator.userAgent.indexOf("MSIE") > -1) {
                    try {
                        $("#" + opts.Img).attr('src', _self.getObjectURL(this.files[0])).attr("width",opts.Width).attr("height",opts.Height);
                    } catch (e) {
                        var src = "";
                        var obj = $("#" + opts.Img);
                    ...
                    $("#" + opts.Img).attr('src', _self.getObjectURL(this.files[0])).attr("width",opts.Width+"px").attr("height",opts.Height+"px");
                }
                opts.Callback();
            }
        });
